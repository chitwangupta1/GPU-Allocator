...
def get_gemini_llm():
    ...
    return LLM(
        ...
        api_key="AIzaSyDDaMMRpfq-OXklLeelMCOZrmic34ZNCuY",
        temperature=0.7
    )
...
def create_agents():
    if gemini_llm is None:
        raise ValueError("Gemini LLM not initialized. Please set GOOGLE_API_KEY environment variable.")
...
class GPUMarketplaceCrew:
    ...
    def analyze_request(self, requester_data: Dict) -> str:
        """Analyze a GPU request and find matches from available lenders"""
        
        if self.agents is None:
            return "Error: AI agents not initialized. Please check your GOOGLE_API_KEY in .env file."
    ...
    def add_borrower(self, borrower_data: Dict) -> Dict:
        ...
        # Run crew analysis
        analysis = self.analyze_request(borrower_data)
...
if __name__ == '__main__':
    ...
    if api_key:
        ...
        print("✓ Using model: gemini-2.0-flash-thinking-exp")
    else:
